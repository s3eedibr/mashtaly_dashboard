...
class SalePlantsTableScreen extends StatefulWidget {
  @override
  _SalePlantsTableScreen createState() => _SalePlantsTableScreen();
}

class _SalePlantsTableScreen extends State<SalePlantsTableScreen> {
